          ...
          child: Form(
            ...
            child: Column(
              ...
              children:[
                ...
                Container(padding: EdgeInsets.only(left: 20),alignment: Alignment.topLeft,child: const Text("Create your\nAccount",textAlign: TextAlign.left,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45),)),
                ...
                Row(
                  ...
                  children: [
                    ...
                    // SizedBox(width: 1,),
                    TextButton(onPressed: () {goLogin(context);}, child: Text("Login", style: TextStyle(fontSize: 13,color: Colors.blueAccent.shade700),))
                  ],
                ),
