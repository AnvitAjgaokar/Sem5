            ...
            children:[
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Login with password',style: TextStyle(fontSize: 15),),
              ...
              Row(
                ...
                children: [
                  ...
                  // SizedBox(width: 1,),
                  TextButton(onPressed: () {goSignup(context);}, child: Text("Sign up", style: TextStyle(fontSize: 13,color: Colors.blueAccent.shade700),))
                ],
              ),
